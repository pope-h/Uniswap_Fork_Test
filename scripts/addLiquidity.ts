...
const main = async () => {
    ...
    const amountUSDCDesired = ethers.parseUnits("200000", 6);
    const amountDAIDesired = ethers.parseUnits("200000", 18); 
    ...
    console.log("WETH Balance Before: ", ethers.formatUnits(wethBal, 18));
    console.log("ETH Balance Before: ", ethers.formatEther(ethBal));
